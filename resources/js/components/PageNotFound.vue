      ...
      <div class="row justify-content-center mt-3">
        ...
        >
          ...
          <path
            ...
            opacity="0.1"
          ></path>
          <ellipse cx="120.3" cy="728.81" rx="88.28" ry="14.18" fill="#6c63ff" opacity="0.1"></ellipse>
          <ellipse cx="912.26" cy="804.71" rx="156.53" ry="15.2" fill="#6c63ff" opacity="0.1"></ellipse>
          <rect
            x="116.14"
            y="107.75"
            width="950.33"
          ...
          <g id="6c975d28-8d47-4ade-9154-b3b78f637b65" data-name="buttons">
            <circle cx="136.57" cy="121.82" r="6.5" fill="#fff"></circle>
            <circle cx="154.07" cy="121.82" r="6.5" fill="#fff"></circle>
            <circle cx="171.57" cy="121.82" r="6.5" fill="#fff"></circle>
          </g>
          <rect x="195.68" y="181.67" width="254.25" height="21.58" fill="#6c63ff" opacity="0.2"></rect>
          <rect x="195.68" y="268.2" width="791.36" height="331.96" fill="#5a5773" opacity="0.1"></rect>
          <path
          ...
          <path
            ...
            fill="#6c63ff"
          ></path>
          <rect x="906.94" y="236.25" width="80.1" height="18.91" fill="#5a5773" opacity="0.1"></rect>
          <path
          ...
          <g opacity="0.1">
            ...
            <path
              ...
              transform="translate(-26.97 -40.04)"
            ></path>
            <polygon points="910.5 291.48 910.5 291.95 927.83 291.95 927.83 291.39 910.5 291.48"></polygon>
            <path
          ...
          <path
            ...
            fill="#6c63ff"
          ></path>
          <rect x="117.46" y="457.19" width="5.68" height="127.9" fill="#535461"></rect>
          <path
