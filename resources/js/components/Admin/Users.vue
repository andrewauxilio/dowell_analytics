                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" name="table_search" class="form-control float-right" placeholder="Search" style="height: 37.5px;">

                            <div class="input-group-append">
                                <button type="submit" class="btn btn-default"><i class="fa fa-search"></i></button>
                            </div>
                            <div class="">
                                <button class="btn btn-success" @click="newUserModal" data-toggle="modal" data-target="#userModal">Add New <i class="fas fa-user-plus fa-fw"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="editmode ? updateUser() : createUser()">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="form.email" type="email" name="email" placeholder="Enter email address here..."
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="form.mobile" type="text" name="mobile" placeholder="Enter mobile phone number here..."
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="form.password" type="password" name="password" placeholder="Enter password here..."
                ...
                .then((result) => {
                    if (result.value) {
                        ...
                        this.form.delete('api/user/' + id).then(() => {
                            ...
                            swal("Failed!", "There was an error deleting the user.", "warning");
                        })
                    }
                })
        },
